...
export const TopSummaryFiveCards = ({
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3 mb-3.5 select-none">
      ...
      {/* 1. Total Sensors */}
      <div className="rounded-2xl bg-[#07131d] border border-slate-800/80 p-3.5 shadow-md flex flex-col justify-between transition-all hover:border-slate-700">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-xl bg-emerald-950/40 border border-emerald-500/30 text-emerald-400 flex items-center justify-center shrink-0">
      ...
      <div className="rounded-2xl bg-[#07131d] border border-slate-800/80 p-3.5 shadow-md flex flex-col justify-between transition-all hover:border-slate-700">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="text-2xl font-black font-mono text-white leading-none">{online}</div>
              <div className="text-xs text-emerald-400 font-semibold mt-1">Online</div>
            </div>
          </div>
          {/* Sparkline matching ref_summary_cards.png */}
          <div className="w-12 h-6 flex items-end">
            <svg viewBox="0 0 48 20" className="w-full h-full stroke-emerald-400 fill-none stroke-[2]">
              <path d="M0,16 L8,15 L16,17 L24,13 L32,15 L40,8 L48,15" />
            </svg>
          </div>
        </div>
        <div className="mt-3 pt-2 border-t border-slate-800/60 flex items-center justify-between text-[10.5px] text-slate-400">
      ...
      <div className="rounded-2xl bg-[#07131d] border border-slate-800/80 p-3.5 shadow-md flex flex-col justify-between transition-all hover:border-slate-700">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-rose-950/40 border border-rose-500/30 text-rose-400 flex items-center justify-center shrink-0">
              <WifiOff className="w-5 h-5" />
            </div>
            <div>
              <div className="text-2xl font-black font-mono text-white leading-none">{offline}</div>
              <div className="text-xs text-slate-400 font-semibold mt-1">Offline</div>
            </div>
          </div>
          {/* Filled mountain sparkline matching ref_summary_cards.png */}
          <div className="w-12 h-6 flex items-end">
      ...
      <div className="rounded-2xl bg-[#07131d] border border-slate-800/80 p-3.5 shadow-md flex flex-col justify-between transition-all hover:border-slate-700">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="text-2xl font-black font-mono text-white leading-none">{avgRisk}</div>
              <div className="text-xs text-teal-400 font-semibold mt-1">Avg. Risk Score</div>
            </div>
          </div>
          {/* Sparkline matching ref_summary_cards.png */}
          <div className="w-12 h-6 flex items-end">
        ...
        <div className="mt-3 pt-2 border-t border-slate-800/60 flex items-center justify-between text-[10.5px]">
          <span className="text-emerald-400 font-semibold">Safe Level</span>
        </div>
      </div>
