...
export const AppLayout = () => {
  ...
  return (
    <div className="min-h-screen w-full max-w-full overflow-x-hidden bg-[#F7FAFC] dark:bg-[#0E131F] text-[#2D3748] dark:text-[#E2E8F0] flex flex-col transition-colors duration-200 box-border">
      ...
      <div className="flex flex-col flex-1 min-h-screen w-full min-w-0 md:pl-20 lg:pl-64 transition-all duration-300">
        ...
        <main className="flex-1 w-full max-w-[1440px] mx-auto min-w-0 p-4 sm:p-5 md:p-6 lg:p-7 xl:p-8 box-border overflow-x-hidden">
          <Outlet />
        </main>
